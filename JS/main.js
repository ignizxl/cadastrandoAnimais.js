//fazendo a importação dos arquivos dataset.js e do bovinos.js

import dataset from "./model/dataset.js";
import bovinos from "./model/bovinos.js";

//definindo função pra calcular a idade dos animais em meses 
 						...
 						<div class="col">
			 				<div class="card">
								...
								<div class="card-body">
				 				...
				 				<p class="card-text"> <b>Id: </b>${bovino.id}<br><b>Peso: </b>${
    bovino.peso
  } Kg<br><b>Data Nascimento: </b>${bovino.datanasc}<br>
